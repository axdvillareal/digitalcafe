...
def pastorders():
    ...
    return render_template('pastorders.html', orderlist = orderlist, ordercount = ordercount)

@app.route('/changepassword', methods = ["GET","POST"])
def changepassword():
    if request.method == "GET":
        return render_template ('changepassword.html', message = None, success = None)
    else:
        ...
        return render_template('changepassword.html',message = changepasswordresult, success = success)
